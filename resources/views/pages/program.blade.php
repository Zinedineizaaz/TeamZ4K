        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: var(--dimsai-red); color: white;">
                    <h5 class="modal-title" id="menuModalLabel"><i class="bi bi-list-check me-2"></i> Produk Yang Sedang Promo</h5>
                ...
                <div class="modal-body" style="background-color: var(--dimsai-bg-light);">
                    ...
                    @else
                        <p class="text-center fw-bold text-secondary">Produk di bawah ini sedang diskon! Pesan sebelum kehabisan.</p>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            @if ($product->image)
                                                {{-- Akses Gambar --}}
                                                <img src="{{ asset('images/' . $product->image) }}" alt="{{ $product->name }}" style="width: 40px; height: 40px; object-fit: cover; border-radius: 5px;" class="me-2">
                                            @endif
                                            **{{ $product->name }}**
                                        </div>
                                    </td>
                ...
                <div class="modal-footer justify-content-center">
                    <a href="{{ url('/contact-us') }}" class="btn btn-danger"><i class="bi bi-bag-check-fill me-2"></i> Pesan Sekarang</a>
